...
export function drawOverlay(ctx,map,eclipseData){
    ...
    const limitNorthP=drawLineOverlay(ctx,map,eclipseData.northPartialLimits, {color: 'black', weight: 1,});
    const limitSouthP=drawLineOverlay(ctx,map,eclipseData.southPartialLimits, {color: 'black', weight: 1});
